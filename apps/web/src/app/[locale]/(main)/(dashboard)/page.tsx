...
import { AnimatedGrid } from "@web/app/[locale]/(main)/(dashboard)/components/animated-grid";
import { AnimatedSection } from "@web/app/[locale]/(main)/(dashboard)/components/animated-section";
import {
  TopMakesSection,
  YearlyChart,
} from "@web/app/[locale]/(main)/(dashboard)/components/charts-section";
import { CoeSection } from "@web/app/[locale]/(main)/(dashboard)/components/coe-section";
import { MarketOverview } from "@web/app/[locale]/(main)/(dashboard)/components/market-overview";
import { MonthlyChangeSummary } from "@web/app/[locale]/(main)/(dashboard)/components/monthly-change-summary";
import { PostsSection } from "@web/app/[locale]/(main)/(dashboard)/components/posts-section";
import { SummaryCard } from "@web/app/[locale]/(main)/(dashboard)/components/summary-card";
import { WelcomeSection } from "@web/app/[locale]/(main)/(dashboard)/components/welcome-section";
