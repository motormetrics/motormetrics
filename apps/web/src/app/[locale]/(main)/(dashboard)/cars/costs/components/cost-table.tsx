...
import { CostLegend } from "@web/app/[locale]/(main)/(dashboard)/cars/costs/components/cost-legend";
import { FUEL_TYPE_LABELS } from "@web/app/[locale]/(main)/(dashboard)/cars/costs/constants";
