import { CostMetrics } from "@web/app/[locale]/(main)/(dashboard)/cars/costs/components/cost-metrics";
import { CostRangeCard } from "@web/app/[locale]/(main)/(dashboard)/cars/costs/components/cost-range-card";
import { CostTable } from "@web/app/[locale]/(main)/(dashboard)/cars/costs/components/cost-table";
import { FuelTypeCostChart } from "@web/app/[locale]/(main)/(dashboard)/cars/costs/components/fuel-type-cost-chart";
import { VesDistributionChart } from "@web/app/[locale]/(main)/(dashboard)/cars/costs/components/ves-distribution-chart";
