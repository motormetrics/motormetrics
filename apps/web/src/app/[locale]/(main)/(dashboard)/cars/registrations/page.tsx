...
import { CategoryTabsSection } from "@web/app/[locale]/(main)/(dashboard)/cars/registrations/components/category-tabs-section";
import { MetricCardsSection } from "@web/app/[locale]/(main)/(dashboard)/cars/registrations/components/metric-cards-section";
import { TopMakesFuelSection } from "@web/app/[locale]/(main)/(dashboard)/cars/registrations/components/top-makes-section";
import { loadSearchParams } from "@web/app/[locale]/(main)/(dashboard)/cars/registrations/search-params";
import { TrendsCompareButton } from "@web/app/[locale]/(main)/(dashboard)/cars/registrations/trends-compare-button";
