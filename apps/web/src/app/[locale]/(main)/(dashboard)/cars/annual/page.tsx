import { CarPopulationChart } from "@web/app/[locale]/(main)/(dashboard)/cars/annual/components/car-population-chart";
import { CarPopulationMetrics } from "@web/app/[locale]/(main)/(dashboard)/cars/annual/components/car-population-metrics";
import { FuelTypeBreakdown } from "@web/app/[locale]/(main)/(dashboard)/cars/annual/components/fuel-type-breakdown";
import { MakeBreakdown } from "@web/app/[locale]/(main)/(dashboard)/cars/annual/components/make-breakdown";
import { VehiclePopulationChart } from "@web/app/[locale]/(main)/(dashboard)/cars/annual/components/vehicle-population-chart";
import { VehiclePopulationMetrics } from "@web/app/[locale]/(main)/(dashboard)/cars/annual/components/vehicle-population-metrics";
