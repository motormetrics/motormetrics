...
import { ComparisonMixedChart } from "@web/app/[locale]/(main)/(dashboard)/coe/components/pqp/comparison-mixed-chart";
import { ComparisonSummaryCard } from "@web/app/[locale]/(main)/(dashboard)/coe/components/pqp/comparison-summary-card";
import { DataTable } from "@web/app/[locale]/(main)/(dashboard)/coe/components/pqp/data-table";
import { RenewalCalculator } from "@web/app/[locale]/(main)/(dashboard)/coe/components/pqp/renewal-calculator";
import { TrendsChart } from "@web/app/[locale]/(main)/(dashboard)/coe/components/pqp/trends-chart";
