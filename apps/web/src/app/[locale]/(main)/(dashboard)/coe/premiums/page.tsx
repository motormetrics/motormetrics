import { FunFactsPqpSection } from "@web/app/[locale]/(main)/(dashboard)/coe/premiums/components/fun-facts-pqp-section";
import { KeyInsightsSection } from "@web/app/[locale]/(main)/(dashboard)/coe/premiums/components/key-insights-section";
import { LatestResultsSection } from "@web/app/[locale]/(main)/(dashboard)/coe/premiums/components/latest-results-section";
import { PremiumRangesSection } from "@web/app/[locale]/(main)/(dashboard)/coe/premiums/components/premium-ranges-section";
