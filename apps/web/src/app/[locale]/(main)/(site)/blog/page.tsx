import { BlogListSection } from "@web/app/[locale]/(main)/(site)/blog/components/blog-list-section";
import { BlogPageHeader } from "@web/app/[locale]/(main)/(site)/blog/components/blog-page-header";
import { BlogSearchInput } from "@web/app/[locale]/(main)/(site)/blog/components/blog-search-input";
import { PopularPostsSection } from "@web/app/[locale]/(main)/(site)/blog/components/popular-posts-section";
import { loadSearchParams } from "@web/app/[locale]/(main)/(site)/blog/search-params";
