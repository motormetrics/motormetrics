...
import { BlogHero } from "@web/app/[locale]/(main)/(site)/blog/components/blog-hero";
import {
  type Highlight,
  KeyHighlights,
} from "@web/app/[locale]/(main)/(site)/blog/components/key-highlights";
import { mdxComponents } from "@web/app/[locale]/(main)/(site)/blog/components/mdx-components";
import { PostNavigation } from "@web/app/[locale]/(main)/(site)/blog/components/post-navigation";
import { ProgressBar } from "@web/app/[locale]/(main)/(site)/blog/components/progress-bar";
import { RelatedPosts } from "@web/app/[locale]/(main)/(site)/blog/components/related-posts";
import { ShareButtons } from "@web/app/[locale]/(main)/(site)/blog/components/share-buttons";
import { TableOfContents } from "@web/app/[locale]/(main)/(site)/blog/components/table-of-contents";
