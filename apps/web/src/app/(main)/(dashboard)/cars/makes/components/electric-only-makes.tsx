  ...
  return (
    <InkPanel>
      <div className="flex items-center gap-2.5">
        ...
        <Typography.TextSm className="font-semibold text-[var(--accent-foreground)]/85 text-base">
          Electric-only makes
        </Typography.TextSm>
      </div>
          ...
          <div className="flex flex-col gap-1.5" key={make.make}>
            <div className="flex items-center">
              <span className="flex min-w-0 items-center gap-2.5">
                ...
                <span className="truncate font-semibold text-[14.5px] text-[var(--accent-foreground)]/85">
                  {make.make}
                </span>
              </span>
