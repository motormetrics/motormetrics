...
import blogListBones from "@web/bones/blog-list.bones.json";
...
import coeOverviewHeaderMetaBones from "@web/bones/coe-overview-header-meta.bones.json";
import coeResultsContentBones from "@web/bones/coe-results-content.bones.json";
...
import funFactsPqpBones from "@web/bones/fun-facts-pqp.bones.json";
import keyInsightsBones from "@web/bones/key-insights.bones.json";
import latestCoeResultsBones from "@web/bones/latest-coe-results.bones.json";
...
import popularPostsBones from "@web/bones/popular-posts.bones.json";
import postsSectionBones from "@web/bones/posts-section.bones.json";
import premiumRangesBones from "@web/bones/premium-ranges.bones.json";
...
const BONE_FALLBACKS = {
  ...
  "coe-overview-header-meta": coeOverviewHeaderMetaBones,
  "coe-results-content": coeResultsContentBones,
  "coe-section": coeSectionBones,
  "deregistrations-content": deregistrationsContentBones,
  "fun-facts-pqp": funFactsPqpBones,
  "key-insights": keyInsightsBones,
  "latest-coe-results": latestCoeResultsBones,
  ...
  "popular-posts": popularPostsBones,
  "posts-section": postsSectionBones,
  "premium-ranges": premiumRangesBones,
