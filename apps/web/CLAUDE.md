...
- **Framework**: Next.js 16.3 with App Router, React 19.2, and TypeScript 7
...
**Charts**: Use HeroUI Pro chart components from `@heroui-pro/react` directly. Do not add local chart wrappers.
...
- **TypeScript**: TypeScript 7 with strict mode enabled
...
- **Chart Components**: Use HeroUI Pro charts imported directly from `@heroui-pro/react`
...
- **Migration Complete**: shadcn/ui and local chart wrappers have been removed; HeroUI v3 and HeroUI Pro charts are the UI foundation
