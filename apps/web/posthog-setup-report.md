...
| `car_make_searched` | User selects a car make on the makes page, by opening its row in the all-makes table | `src/app/(main)/(dashboard)/cars/makes/components/makes-table.tsx` |
...
| `blog_category_tab_changed` | User switches between blog category tabs (All, COE, Cars) | `src/app/(main)/(site)/blog/components/blog-list.tsx` |
